...
func buildTcbExpression(expression string) string {
	s, err := utils.ParseText([]byte(expression), utils.AngularExpr, "", func(root *sitter.Node, content []byte, _ string) (string, error) {
